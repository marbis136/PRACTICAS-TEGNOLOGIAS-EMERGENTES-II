...
indices = [0, 20]
X = data.data[:, indices]  # Usamos solo las dos primeras características (longitud y ancho del sépalo) para graficar
y = data.target
...
svm_model = SVC(kernel='rbf', gamma=0.5, C=1.0, decision_function_shape='ovo')  # 'ovo' para clasificación multiclase
